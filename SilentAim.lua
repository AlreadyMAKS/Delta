...
silent_aim_hook = hookfunction(require(game.ReplicatedStorage.Modules.FPS.Bullet).CreateBullet, function(...)
   ...
   if _G.SilentAimActive and CHEAT_CLIENT:get_target() then
       ...
       local target_part = CHEAT_CLIENT:get_target() and CHEAT_CLIENT:get_target().Character:FindFirstChild(_G.SilentAimTarget)
